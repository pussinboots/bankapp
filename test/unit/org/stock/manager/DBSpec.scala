...
class DBSpec extends PlaySpecification {
  ...
  "DB" should {
    "given no jdbc url as CLEARDB_DATABASE_URL property return local jdbc url" in {
      ...
      dburl._1 must beEqualTo("jdbc:mysql://127.0.0.1:3306/heroku_9852f75c8ae3ea1?autoReconnectForPools=true&reconnect=true&useSSL=true&useUnicode=yes&characterEncoding=UTF-8")
    ...
    "given default CLEARDB_DATABASE_URL property return mysql datasource" in {
      ...
      datasource.getJdbcUrl() must beEqualTo("jdbc:mysql://127.0.0.1:3306/heroku_9852f75c8ae3ea1?autoReconnectForPools=true&reconnect=true&useSSL=true&useUnicode=yes&characterEncoding=UTF-8")
